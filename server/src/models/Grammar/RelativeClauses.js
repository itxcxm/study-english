...
const relativeClausesSchema = new Schema(
  {
    question: {
      type: String,
      required: true,
...
relativeClausesSchema.index({ isActive: 1 });

const RelativeClauses = mongoose.model(
  "RelativeClauses",
  relativeClausesSchema
);

export { RelativeClauses };
